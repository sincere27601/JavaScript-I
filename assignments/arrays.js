...
let lastCar = 54
console.log("Lincoln, TownCar");

// ==== Challenge 3 ====
// The marketing team wants the car models listed alphabetically on the website. Sort all the car model names into alphabetical order and log the results in the console
let carModels = ["Navigator, Miata MX-5, Defender Ice Edition, Accord, Galant, Accord, Fortwo, 4000cs Quattro, Windstar, E-Class, G35, Espirit, Cavalier, Ram Van 1500, Intrepid, Montero sport, Skylark, Prism, Bravada, Familia, Exress 1500, Wrangler, Talon, MR2, 525, Escalade, Q, Aerio, Topaz, 6 series, GTO, Ram Van 3500, Wrangler, Escort, 300M, XC70, LSS, Camry, Econoline E250, Evora, Mustang, Yukon, R-Class, Q7, TT, Ciera, Jetta, Magnum, Sebring, Town Car "];
let carModelsSorted = [];
